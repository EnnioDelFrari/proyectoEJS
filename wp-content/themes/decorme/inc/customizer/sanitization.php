 ...
 */
function decorme_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function decorme_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function decorme_sanitize_html( $html ) {
 ...
 */
function decorme_sanitize_image( $image, $setting ) {
 ...
 */
function decorme_sanitize_nohtml( $nohtml ) {
 ...
 */
function decorme_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function decorme_sanitize_range_value( $number, $setting ) {
 ...
 */
function decorme_sanitize_select( $input, $setting ) {
 ...
 */
function decorme_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function decorme_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function decorme_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
